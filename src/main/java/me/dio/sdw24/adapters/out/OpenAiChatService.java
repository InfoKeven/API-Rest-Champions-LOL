...
@ConditionalOnProperty(name = "generative-ai.provaider", havingValue = "OPENAI")
@FeignClient(name = "OpenAiChatApi", url = "${openai.api-key}", configuration = OpenAiChatService.Config.class)
public interface OpenAiChatService extends GenerativeAiService {
    ...
    default String generateContent(String objective, String context) {
        ...
        try {
            ...
            return "Deu ruim mais ainda! O retorno da API da OpenAI não contem os dados esperados.";
        }
    }
